                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-content">
                                <h1>Ongoing Support & Optimization</h1>
                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>We provide comprehensive application support services to ensure your software runs smoothly, securely, and without disruption.</p>
                                <span className="line-break" />
                                <p>Our support extends beyond routine maintenance—we work closely with you to understand your evolving needs and ensure your application adapts to new challenges. From regular updates and enhancements to user training and technical troubleshooting, we deliver responsive, dependable support that grows with your business. </p>
                            </div>
                            <div className="col-xl-5 col-lg-6">
                                <h2>Key Feature</h2>
                                <span className="line-break" />
                                ...
                                <ul className="listing two">
                                    ...
                                    <li>
                                        ...
                                        Integration & Compatibility Support
                                    </li>
                                    <li>
                                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
