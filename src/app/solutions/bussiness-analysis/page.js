                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-content">
                                <h1>Bussiness & Product Strategy</h1>
                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>We work closely with stakeholders to understand the core challenges, identify opportunities, and define clear, actionable requirements. Through thorough market research, competitor analysis, and stakeholder interviews, we uncover insights that drive strategic decisions</p>
                                <span className="line-break" />
                                <p>From defining project scope and mapping business processes to writing detailed documentation and facilitating communication between teams, our analysts play a critical role in successful project delivery.
