                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-content">
                                <h1>AI, Automation & Data Insights</h1>
                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>At FirstMethod, we help businesses unlock the full potential of their data through cutting-edge AI solutions, smart automation, and actionable insights. Our team leverages machine learning models, natural language processing, and predictive analytics to streamline operations, reduce manual effort, and drive intelligent decision-making.</p>
                                <span className="line-break" />
                                <p>With FirstMethod, your data becomes more than just information—it becomes a strategic asset for growth.</p>
                            </div>
                            <div className="col-xl-5 col-lg-6">
                                <h2>Key Feature</h2>
                                <span className="line-break" />
