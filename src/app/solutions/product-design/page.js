                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>Our UI/UX design process is grounded in research, strategy, and empathy, ensuring that every interface is not only visually appealing but also functionally effective.</p>
                                <span className="line-break" />
                                <p>Whether you're building a new product or refining an existing one, our team collaborates closely with you to ensure every interaction feels natural and impactful. With a balance of aesthetics and functionality, we transform ideas into digital products that are both beautiful and purposeful.
