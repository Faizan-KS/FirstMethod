                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        {/* <div className="row justify-content-center">
                            <div className="col-xl-8 col-lg-10">
                                <div className="post-title-and-tag">
                                    <h2>App Development (Android &amp; iOS)</h2>
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>We specialize in crafting dynamic, visually engaging, and fully optimized mobile applications that deliver real results. Our mobile app development and design services are customized to align with your unique business goals, ensuring a seamless user experience that not only looks stunning but also functions flawlessly across devices.</p>
                                <span className="line-break" />
                                <p>This milestone reflects the hard work, creativity, and commitment of our exceptional team, along with the continued trust and support of our clients and partners. We’re deeply grateful for the collaboration that has driven our success in the mobile space.
                            ...
                            <div className="col-xl-5 col-lg-6">
                                <h2>Key Feature</h2>
                                <span className="line-break" />
                                <p>Here are some key features of App Development &amp; Design that  highlight:</p>
                                <span className="line-break" />
