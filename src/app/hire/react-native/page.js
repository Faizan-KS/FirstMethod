          ...
          <div className="details-content-wrap mb-130">
            ...
            {/* <div className="row justify-content-center">
                            <div className="col-xl-8 col-lg-10">
                                <div className="post-title-and-tag">
                                    <h2>AI, Automation & Data Insights </h2>
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  Our React Native developers specialize in crafting mobile apps
                  that feel truly native while maintaining cross-platform
                  efficiency. They are experienced in designing apps that are
                  responsive, user-friendly, and optimized for both performance
                  and usability.
                </p>
                <span className="line-break" />
                <p>
                  From startups to growing businesses, we ensure every React
                  Native project is handled with care, communication, and
                  attention to your goals. Clients can expect flexibility, quick
                  iteration cycles, and on-time delivery.
                </p>
              </div>
              <div className="col-xl-5 col-lg-6">
                <h2>Key Services</h2>
                ...
                <ul className="listing two">
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        </svg>Cross-platform mobile app development</li>
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
                                        </svg>State management and app architecture</li>
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
                                        </svg>Native module integration (camera, GPS, etc.)</li>
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
                                        </svg>App store submission and publishing</li>
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
                                        </svg>Codebase migration from native to React Native</li>
                  <li><svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.5236 9.35783L6.0516 11.5708C6.99992 10.2009 11.2151 3.50919 13.6388 0.400391C11.1287 5.14183 8.94664 10.0882 6.98408 15.0588C6.70248 15.7717 5.69832 15.7839 5.40264 15.0767C4.46776 12.8415 3.46264 10.6202 2.36328 8.46199C3.15368 8.30391 3.99656 8.56743 4.52344 9.35783H4.5236Z" />
                                        </svg>OTA updates and post-launch support</li>
                </ul>
              </div>
            </div>
            ...
            <span className="line-break" />
            <span className="line-break" />
            <h2 className="text-center">Want help choosing the right expert? Just fill out the form below. </h2>
            {/* <span className="line-break" />
            <h2>Why Choose Us?</h2>
            <span className="line-break" />
            <p className="fixed-width">
              Present measurable results achieved after the project launch. This
              section should be data-driven to show the impact of your work,
              such as:
            </p>
            <span className="line-break" />
            <span className="line-break" />
            <div className="row g-4">
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="single-service">
                  <h5>
                    <span>2.</span> Tailored Solutions
                  </h5>
                </div>
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="single-service three">
                  <h5>
                    <span>3.</span> SEO Optimize Focused
                  </h5>
                </div>
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6">
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="single-service">
                  <h5>
                    <span>5.</span> ROI on digital ad spend
                  </h5>
                </div>
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="single-service four">
                  <h5>
                    <span>6.</span> Target Client Satisfaction
                  </h5>
                </div>
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6">
