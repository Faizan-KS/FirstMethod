  ...
  return (
    <>
      ...
      <div className="pricing-plan-page mb-130">
        <div className="container">
          <div
            className="nav-area wow animate fadeInDown"
              ...
              <div className="row gy-5">
                ...
                >
                  <div className="pricing-plan-card magnetic-item">
                    <div className="pricing-plan-top">
                      ...
                      <h2>
                        $299 <sub>/per month</sub>
                      </h2>
                    </div>
                    <p>
                      The <strong>Standard Plan</strong> provides a balanced
                      offering with both content creation, SEO, and social media
                      management.
                    </p>
                    <Link
                      href="/contact"
                      className="primary-btn3 white-bg btn-hover"
                    >
                      7 Days for Free
                      <svg
                        width={10}
                        ...
                        <li>
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M2.5236 9.35783L4.0516 11.5708C4.99992 10.2009 9.21512 3.50919 11.6388 0.400391C9.12872 5.14183 6.94664 10.0882 4.98408 15.0588C4.70248 15.7717 3.69832 15.7839 3.40264 15.0767C2.46776 12.8415 1.46264 10.6202 0.363281 8.46199C1.15368 8.30391 1.99656 8.56743 2.52344 9.35783H2.5236Z"
                            />
                          </svg>
                          Custom UX/UI Design
                        </li>
                ...
                >
                  <div className="pricing-plan-card magnetic-item premium">
                    ...
                    <p>
                      The <strong>Premium Plan</strong> is designed for
                      businesses seeking comprehensive digital solutions, from
                ...
                >
                  <div className="pricing-plan-card magnetic-item enterprise">
                    ...
                    <p>
                      The <strong>Enterprise Plan</strong> is ideal for large
                      businesses or corporations that require a full-scale
