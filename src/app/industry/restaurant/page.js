          ...
          <div className="details-content-wrap mb-130">
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We offer fully integrated digital solutions for restaurants,
                  cafes, and food service businesses to manage reservations,
                  orders, payments, and customer engagement with ease.{" "}
                </p>
                <span className="line-break" />
                <p>
                  Our restaurant management systems ensure smooth front- and
                  back-of-house operations while promoting long-term customer
                  retention.
                </p>
              </div>
              <div className="col-xl-5 col-lg-6">
