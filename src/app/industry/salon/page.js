          ...
          <div className="details-content-wrap mb-130">
              ...
              <div className="col-xl-8 col-lg-10">
                <div className="post-title-and-tag">
                  ...
                  <ul className="tag-list">
                    <li>
                      <Link href="/service">Custom</Link>
                    </li>
                    <li>
                      <Link href="/service">Responsive</Link>
                    </li>
                    <li>
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We provide tailored digital solutions for salons, spas, and
                  beauty service providers to streamline appointment bookings,
                  manage staff schedules, and enhance customer engagement.{" "}
                </p>
                <span className="line-break" />
                <p>
                  Whether you're running a single-location salon or managing
                  multiple branches, we help you digitize your operations for
              ...
              <div className="col-xl-5 col-lg-6">
                <h2>Key Features</h2>
                <span className="line-break" />
                <p>Here are some key features we provide</p>
                <span className="line-break" />
                <ul className="listing two">
                  ...
                  <li>
                    ...
                    Customer History & Preference Tracking{" "}
                  </li>
                </ul>
              </div>
            </div>
