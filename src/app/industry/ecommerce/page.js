          ...
          <div className="details-content-wrap mb-130">
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We provide tailored e-commerce development services that help
                  businesses launch, manage, and scale online stores with ease.
                  From custom storefront design to seamless checkout systems and
                  product inventory management, our solutions are built to
                  deliver high-conversion shopping experiences.
                </p>
                <span className="line-break" />
                <p>
                  Our mission is to turn your digital presence into a powerful
                  sales engine.
                </p>
              </div>
              <div className="col-xl-5 col-lg-6">
