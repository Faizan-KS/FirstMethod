                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>We provide end-to-end technology solutions tailored for the food delivery industry, empowering restaurants, cloud kitchens, and delivery platforms to streamline their operations and enhance customer satisfaction.</p>
                                <span className="line-break" />
                                <p>Whether you're launching a new delivery platform or scaling an existing one, we ensure your service is fast, reliable, and optimized for both convenience and performance..
