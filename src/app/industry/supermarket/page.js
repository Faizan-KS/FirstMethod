          ...
          <div className="details-content-wrap mb-130">
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We provide modern, scalable digital solutions for supermarkets
                  and grocery chains, enabling them to manage inventory,
                  streamline checkout, and offer seamless online and offline
                  shopping experiences.{" "}
                </p>
                <span className="line-break" />
                <p>
                  We deliver reliable systems that help you stay competitive and
              ...
              <div className="col-xl-5 col-lg-6">
                ...
                <ul className="listing two">
                  ...
                  <li>
                    ...
                    Sales Reports & Real-Time Analytics{" "}
                  </li>
                </ul>
              </div>
            </div>
