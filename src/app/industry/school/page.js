          ...
          <div className="details-content-wrap mb-130">
            ...
            <div className="row justify-content-center">
              <div className="col-xl-8 col-lg-10">
                <div className="post-title-and-tag">
                  <h2>School Management Solutions</h2>
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We offer comprehensive digital solutions for schools and
                  educational institutions to simplify academic, administrative,
                  and communication processes.{" "}
                </p>
                <span className="line-break" />
                <p>
                  Whether it's a single school or a multi-branch institution,
                  our systems are designed to scale efficiently while ensuring
                  data security and seamless user experiences for students,
