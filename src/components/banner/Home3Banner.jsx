  ...
  return (
    <>
      <div className="home3-banner-section">
        {/* Above div had classname as home3-banner-section */}
        <div className="container-fluid">
          <div className="row gy-5 align-items-center flex-row-reverse justify-content-between">
                            ...
                            <div className="home3-video-wrapper">
                                <div className="video-area" ref={videoAreaRef}>
                                    ...
                                    <div className="content">
                                        <h6>First Method . Digital Agency</h6>
                                        <span>(2011-2024)</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="col-lg-6">
              <div className="banner-content-wrap">
                <div className="banner-content">
                  <span>The New Era of Building Starts Here</span>
                  <h1>
                    From Zero to Infinity
                  </h1>
                  <h2>Where Bold Ideas Meet Smart
                    Execution</h2>
                  <p>
                    We provide consulting and technology services to help you
                    build better, work smarter, and grow faster.
                  </p>
