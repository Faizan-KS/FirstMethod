            ...
            <div className="home5-process-section">
                <div className="container">
                    <div className="row g-4 align-items-center justify-content-between mb-70 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="col-lg-5 col-md-7">
                            <div className="section-title four">
                                <h2>First Method’s 4-Step Process.</h2>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-4 d-flex justify-content-lg-end">
                            <div className="result-area">
                                <span>100%</span>
                                <p>Client Satisfaction is <br/> Our First Priority.</p>
                        ...
                        <div className="row gy-md-5 gy-4">
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="process-card3">
                                    ...
                                    <h5>Discover & Define</h5>
                                    <p>We listen, ask questions, and diagnose your real challenge — whether it’s unclear messaging, broken systems, or stalled growth.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center">
                                <div className="process-card3">
                                    ...
                                    <h5>Design & Build</h5>
                                    <p>We map out your solution — brand, product, system, or campaign — and begin building fast with the right tools, tech, and creative direction.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center">
                                <div className="process-card3">
                                    ...
                                    <p>We go live, test, and learn — analyzing performance and making quick improvements based on real feedback or data.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-end">
                                <div className="process-card3">
                                    ...
                                    <h5> Scale & Support</h5>
                                    <p>We help you grow what works — with continuous support, iteration, optimization, and handover-ready documentation.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="contact-area">
                        <p>See How It Would Work for You</p>
                        <Link href="/contact">
                            Contact Us
