            ...
            <div className="col-lg-3">
              <div className="company-logo-and-location-area">
                <div className="company-logo-area">
                  <img src="/assets/img/logo_temp.png" alt="" />
                ...
                <ul className="location-list">
                    <li>
                      ...
                      <a href="https://www.google.com/maps">
                        123 Business St., Suite 456, City, State, ZIP Code,
                        Country
                      </a>
                    </li>
                    <li>
                      <span>Australia</span>
                      <a href="https://www.google.com/maps">
                        123 Innovation Road, Suite 101Tech City, State, ZIP Code
                        Country
                      </a>
                    </li>
                  </ul>
              ...
              <div className="footer-contact-wrap">
                <div className="title-and-contact">
                  <div className="title-area">
                    <h2>
                      A full-stack consulting and technology company helping
                      businesses of all sizes go from idea to execution — and
                      scale from Zero to Infinity.
                    </h2>
                  </div>
                  <ul className="contact-list flex justify-content-between">
                    <li className="single-contact">
                      ...
                      <div className="content">
                        ...
                        <a href="mailto:info@example.com">hello@firstmethod.tech</a>
                      </div>
                    </li>
                    <li className="single-contact">
                      <div className="icon">
                        <img
                          src="/assets/img/home1/icon/contact-whatsapp-icon.svg"
                          alt=""
                        />
                      </div>
                      <div className="content">
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="copyright-and-social-area">
            <p>
              Copyright 2025 <a href="https://www.firstmethod.tech/">First Method</a> |
              All Right Reserved.
            </p>
