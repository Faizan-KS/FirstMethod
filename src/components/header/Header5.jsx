...
const Header5 = () => {
  ...
  return (
    <>
      ...
      <header
        className={`header-area style-5 ${state.scrollY > 20 ? "sticky" : ""}`}
      >
        <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
              ...
              <ul className="menu-list">
                ...
                >
                  ...
                  >
                    <div className="container">
                      <div className="row align-items-lg-top justify-content-between">
                          ...
                          <ul className="menu-row">
                            <li className="menu-single-item">
                              ...
                              <ul>
                                ...
                                <li>
                                  <Link href="/solutions/app-support">
                                    <svg
                                      width={22}
                                      height={22}
                                      viewBox="0 0 22 22"
                                ...
                                <li>
                                  <Link href="/solutions/bussiness-analysis">
                                    <svg
                                      width={22}
                                      height={22}
                                      viewBox="0 0 22 22"
                            ...
                            <li className="menu-single-item">
                              ...
                              <ul>
                                <li>
                                  <Link href="/industry/food-delivery">
                                    Food Delivery
                                  </Link>
                                </li>
                                <li>
                                  <Link href="/industry/school">School</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                  <Link href="/industry/restaurant">
                                    Restaurant
                                  </Link>
                                </li>
                                <li>
                                  <Link href="/industry/supermarket">
                                    Super Market
                                  </Link>
                                </li>
                                <li>
                                  <Link href="/industry/salon">Salon</Link>
                                </li>
                                {/* <li>
                                  <Link href="/industries" className="all-btn">
                                    View all
                                    <svg
                                      width={10}
                                      height={10}
                        ...
                        <div className="col-lg-4">
                          <div className="solution-menu-banner">
                            <div className="banner-content">
                              <h3>
                                We have Daynamic Team Members that Easily
                                Problem Solve.
                              </h3>
                            ...
                            <div className="banner-img">
                              <img
                                src="/assets/img/home5/header5-img.png"
                                alt=""
                              />
                            </div>
                          </div>
                ...
                <li className={`menu-item-has-children `}>
                  ...
                  >
                    ...
                    <li
                      className={
                        pathname === "/company/pricing" ? "active" : ""
                      }
                    >
                      <Link href="/company/pricing">Pricing Plan</Link>
                    </li>
                    <li
                      className={
                        pathname.startsWith("/company/career") ? "active" : ""
                      }
                    >
                      <Link href="/company/career">Career</Link>
                    </li>
                    <li className={pathname === "/company/faq" ? "active" : ""}>
                      <Link href="/company/faq">FAQ’s</Link>
                    </li>
                    <li
                      className={
                        pathname === "/company/contact" ? "active" : ""
                      }
                    >
          ...
          <div className="nav-right">
            ...
            <Link className="primary-btn5 two d-lg-flex d-none" href="/contact">
              Let’s Talk
              <svg
                width={10}
                height={10}
